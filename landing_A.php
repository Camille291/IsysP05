...
<body>
    <header>
        <a href="" class="logo"><span>P</span>roject <span>IsysP05</span></a>
        <div class="toggleMenu" onclick="toggleMenu();"></div>
        <ul class="navbar">
            <li><a href="#Temperature_blanc" onclick="toggleMenu();">Temperature</a></li>
            <li><a href="#Tension_blanc" onclick="toggleMenu();">Blood pressure</a></li>
            <li><a href="#BPM_blanc" onclick="toggleMenu();">Pulse</a></li>
            <li><a href="#Poids_blanc" onclick="toggleMenu();">Weight</a></li>
            <li><a href="#Taille_blanc" onclick="toggleMenu();">Height</a></li>
            <a href="IsysP05_achat_A.html" class="btn_Compte">Shop</a>
            <a href="deconnexion_A.php" class="btn_Compte">Log out</a>
         ...
         <section class="Nous" id="Nous">
            <br><br>
            <div class="text">
                <h3 class="p-5">Hello <?php echo $data['prenom']; ?> !</h3>
            </div>
            <br><br>
            <div class="IMC_blanc" id="IMC_blanc" >
                ...
                <div class="imc-frise">
                    <div class="zone-insuffisance">
                        <h3 class="black">Underweight</h3>
                    </div>
                    <div class="zone-normal">
                        <h3 class="black">Regular weight</h3>
                    </div>
                    <div class="zone-surpoids">
                        <h3 class="black">Overweight</h3>
                    </div>
                    <div class="zone-obesite">
                        <h3 class="black">Obesity</h3>
                    </div>
            ...
            <div class="contenu">
                <div class="box">
                    <div class="text">
                        ...
                        <br><br>
                        <h3 class="gris"> from <?php echo $lastPoidsDate; ?> </h3>
                    </div>
                </div>
                ...
                <div class="box">
                    <div class="text">
                        ...
                        <br><br>
                        <h3 class="gris"> from <?php echo $lastTailleDate; ?> </h3>
                    </div>
                </div>
                <div class="box">
                    <div class="text">
                        ...
                        <br><br>
                        <h3 class="gris"> from <?php echo $lastfrequence_cardiaqueDate; ?> </h3>
            ...
            <div class="contenu">
                <div class="box">
                    <div class="text">
                        ...
                        <br><br>
                        <h3 class="gris"> from <?php echo $lasttemperatureDate; ?> </h3>
                    </div>
                </div>

                <div class="box">
                    <div class="text">
                        <h3>Last blood pressure: </h3>
                        <h3 class="orange"> <?php echo $lastsystole; ?> mmHg</h3>
                        <h3 class="orange"> <?php echo $lastdiastole; ?> mmHg</h3>
                        <br><br>
                        <h3 class="gris"> from <?php echo $lastTensionDate; ?> </h3>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="Temperature_blanc" id="Temperature_blanc" >
            <div class="graphique-container">
                ...
                <div class="container">
                    <h2 class="text-centerbis">Temperature</h2>
                    <div class="login-form">
                        <div class="titre-container">
                            <h2 class="text-center">Add a value</h2>
                        </div>
                        <form method="post" action="temperature_traitement.php">
                            <ul>If the measurement has been:
                                <br><br>
                                <li>anal measurement: do not add anything to your measure </li>
                                <li>oral measurement: add 0,6 °C </li>
                                <li>underarm measurement: add 0,7 °C </li>
                            </ul>
                            <br><br>
                            <div class="form-group">
                                <input type="temperature" name="temperature" class="form-control" placeholder="Temperature (°C)" required="required" autocomplete="off">
                            </div>
                            <div class="form-group">
        ...
        <section class="Tension_blanc" id="Tension_blanc">
            <div class="graphique-container">
                <div class="container">
                    <h2 class="text-centerbis">Blood pressure</h2>
                    <div class="login-form">
                        <div class="titre-container">
                            <h2 class="text-center">Add a value</h2>
                        </div>
                        <form method="post" action="tension_traitement.php">
                            <div class="form-group">
                                <input type="systole" name="systole" class="form-control" placeholder="Systole (mmHg)" required="required" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input type="diastole" name="diastole" class="form-control" placeholder="Diastole (mmHg)" required="required" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input type="date" name="date_prise" class="form-control" required="required" autocomplete="off" />
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="login-form">
                        ...
                        <form method="post" action="frequence_cardiaque_traitement.php">
                            <div class="form-group">
                                <input type="frequence_cardiaque" name="frequence_cardiaque" class="form-control" placeholder="Pulse (BPM)" required="required" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input type="date" name="date_prise" class="form-control" required="required" autocomplete="off" />
                            </div>
        ...
        <section class="Poids_blanc" id="Poids_blanc" >
            <div class="graphique-container">
                <div class="container">
                    <h2 class="text-centerbis">Weight</h2>
                    <div class="login-form">
                        <div class="titre-container">
                            <h2 class="text-center">Add a value</h2>
                        </div>
                        <form method="post" action="poids_traitement.php">
                            <div class="form-group">
                                <input type="poids" name="poids" class="form-control" placeholder="Weight (kg)" required="required" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input type="date" name="date_prise" class="form-control" required="required" autocomplete="off" />
                            </div>
        ...
        <section class="Taille_blanc" id="Taille_blanc">
            <div class="graphique-container">
                ...
                <div class="container">
                    <h2 class="text-centerbis">Height</h2>
                    <div class="login-form">
                        <div class="titre-container">
                            <h2 class="text-center">Add a value</h2>
                        </div>
                        <form method="post" action="taille_traitement.php">
                            <div class="form-group">
                                <input type="taille" name="taille" class="form-control" placeholder="Height (cm)" required="required" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input type="date" name="date_prise" class="form-control" required="required" autocomplete="off" />
                            </div>
